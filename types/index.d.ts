...
export interface AssignApartmentResponse extends ApartmentData {
    tenant: string;
}

export interface AssignApartmentData {
    tenant: string;
}
...
// TOP POSTS AND POPULAR TAGS INTERFACES
...
// REPORT AND ISSUE-RELATED INTERFACES
...
// MESSAGE RESPONSE, for BookmarkResponse UpvoteDownvoteResponse AssignApartmentResponse
